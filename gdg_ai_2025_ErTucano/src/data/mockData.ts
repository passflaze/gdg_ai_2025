    ...
    chapters: [
      {
        ...
        progress: 100,
        materials: [
          { id: 'm1', title: 'Vectors and Spaces', type: 'note', progress: 100, dateCreated: '2025-05-10' },
          { id: 'm2', title: 'Matrix Operations', type: 'slide', progress: 100, dateCreated: '2025-05-12' }
        ],
        prerequisites: []
      },
      {
        ...
        progress: 85,
        materials: [
          { id: 'm3', title: 'Limits and Continuity', type: 'note', progress: 100, dateCreated: '2025-05-15' },
          { id: 'm4', title: 'Differentiation Rules', type: 'flashcard', progress: 70, dateCreated: '2025-05-17' }
        ],
      ...
      },
      {
        ...
        progress: 40,
        materials: [
          { id: 'm5', title: 'Integration Techniques', type: 'summary', progress: 40, dateCreated: '2025-05-20' }
        ],
    ...
    chapters: [
      {
        ...
        progress: 90,
        materials: [
          { id: 'p1', title: 'Newton\'s Laws', type: 'note', progress: 100, dateCreated: '2025-05-05' },
      ...
      },
      {
        ...
        progress: 60,
        materials: [
          { id: 'p3', title: 'Maxwell\'s Equations', type: 'note', progress: 60, dateCreated: '2025-05-14' }
        ],
    ...
    chapters: [
      {
        ...
        progress: 95,
        materials: [
          { id: 'c1', title: 'Arrays and Linked Lists', type: 'note', progress: 100, dateCreated: '2025-05-03' },
      ...
      },
      {
        ...
        progress: 70,
        materials: [
          { id: 'c3', title: 'Sorting Algorithms', type: 'note', progress: 80, dateCreated: '2025-05-11' },
    ...
    chapters: [
      {
        ...
        progress: 80,
        materials: [
          { id: 'b1', title: 'Cell Structure', type: 'note', progress: 90, dateCreated: '2025-05-04' },
      ...
      },
      {
        ...
        progress: 40,
        materials: [
          { id: 'b3', title: 'DNA Replication', type: 'note', progress: 40, dateCreated: '2025-05-18' }
        ],
