...
import { FileText, PresentationIcon, BookOpen, BookMarked, X } from 'lucide-react';
...
const MaterialItem: React.FC<MaterialItemProps> = ({ material }) => {
  const { setSelectedMaterial } = useAppContext();
  ...
  return (
    <CardContainer 
      className="h-full flex flex-col transition-all duration-300 hover:border-purple-500 border border-transparent cursor-pointer"
      onClick={handleClick}
    >
